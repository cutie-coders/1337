...
public:
	...
	c_window() {
		...
		this->g_active_element = nullptr;
		this->hint.clear();
	}
	void set_padding(Vector2D value) {
		this->padding = value;
	}
	void set_on_click_back(void(*on_click_back)()) {
		this->on_click_back = on_click_back;
	}
	void update_state(void(*fn)()) {
		update_state_fn = fn;
	}
