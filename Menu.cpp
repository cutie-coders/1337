...
namespace skins_tab {
	...
	void init_settings() {
		static const std::vector<std::string> agent_skins = {
			...
			str("Michael Syfers | FBI Sniper"),
			str("Operator | FBI SWAT"),
			str("Special Agent Ava | FBI"),
			str("Markus Delrow | FBI HRT"),
			str("Sous-Lieutenant Medic | Gendarmerie Nationale"),
			str("Chem-Haz Capitaine | Gendarmerie Nationale"),
			str("Chef d'Escadron Rouchard | Gendarmerie Nationale"),
			str("Aspirant | Gendarmerie Nationale"),
			str("Officer Jacques Beltram | Gendarmerie Nationale"),
			str("D Squadron Officer | NZSAS"),
			str("B Squadron Officer | SAS"),
			str("Seal Team 6 Soldier | NSWC SEAL"),
			str("Buckshot | NSWC SEAL"),
			str("Lt. Commander Ricksaw | NSWC SEAL"),
			str("'Blueberries' Buckshot | NSWC SEAL"),
			str("3rd Commando Company | KSK"),
			str("'Two Times' McCoy | TACP Cavalry"),
			str("'Two Times' McCoy | USAF TACP"),
			str("Primeiro Tenente | Brazilian 1st Battalion"),
			str("Cmdr. Mae 'Dead Cold' Jamison | SWAT"),
			str("1st Lieutenant Farlow | SWAT"),
			str("Bio-Haz Specialist | SWAT"),
