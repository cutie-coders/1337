...
namespace hs {
	...
	_(shaderapidx9_dll, "shaderapidx9.dll"); // shaderapidx9.dll
	...
	_(tier0_dbgbreak, "CC F3 0F 10 4D ? 0F 57 C0"); //CC F3 0F 10 4D ? 0F 57 C0
	...
	_(string_table, "VEngineClientStringTable001"); // VEngineClientStringTable001
	...
	_(ret_engine, "85 C0 74 2D 83 7D 10 ? 75 1C"); // \x85\xC0\x74\x2D\x83\x7D\x10\x00\x75\x1C
	...
	_(cl_move, "55 8B EC 81 EC ? ? ? ? 53 56 8A F9 F3 0F 11 45 ? 8B");
	...
	_(calc_view_model_view, "55 8B EC 83 EC 58 56 57"); // 55 8B EC 83 EC 58 56 57
	_(add_view_model_bob, "55 8B EC A1 ? ? ? ? 83 EC 20 8B 40 34"); // 55 8B EC A1 ? ? ? ? 83 EC 20 8B 40 34
	_(d3d_device, "A1 ? ? ? ? 50 8B 08 FF 51 0C"); // A1 ? ? ? ? 50 8B 08 FF 51 0C
	...
	_(Hooked_DrawModel, "Hooked_DrawModel");
	...
	_(Hooked_EndScene, "Hooked_Present");
	_(Hooked_Reset, "Hooked_Reset");
}